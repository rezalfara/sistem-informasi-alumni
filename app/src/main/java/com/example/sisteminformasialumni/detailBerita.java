...
//        //initializing the productlist
    ...
    public void onBackPressed() {
        super.onBackPressed();
        startActivity(new Intent(detailBerita.this, NewsActivityAdmin.class));
        finish();
    }
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            String tgl_posting = berita.getString("tgl_posting");

                            // Menambahkan data ke detailAlumniList
                            detailBeritaList.add(new Berita(
                                    id_berita, judul, foto, deskripsi, tgl_posting
                            ));

                            // Membuat adapter dan mengaturnya ke recyclerview
                            detailBeritaAdapter detailBeritaAdapter = new detailBeritaAdapter(detailBerita.this, detailBeritaList);
                            rvDetailBerita.setAdapter(detailBeritaAdapter);

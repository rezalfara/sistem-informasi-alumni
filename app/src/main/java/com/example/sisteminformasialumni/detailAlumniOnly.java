...
public class detailAlumniOnly extends AppCompatActivity {
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            detailAlumniOnlyAdapter detailAlumniOnlyAdapter = new detailAlumniOnlyAdapter(detailAlumniOnly.this, detailAlumniList, jurusanList, tahunLulusList);
                            rvDetailAlumni.setAdapter(detailAlumniOnlyAdapter);
